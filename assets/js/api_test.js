/**
 * API Communication Module - Test Version
 * Handles communication with the local backend for integration testing
 */
...
class APIClient {
    ...
    async validateToken(token, deviceFingerprint) {
        try {
            ...
            console.log('Validating token with backend...', payload);
